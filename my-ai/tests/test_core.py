...
from myai.engine import registry_errors, repo_root, score_session
from myai.events import classify_free_text
from myai.exports import export_persona
from myai.fit import rank_products
from myai.metrics import build_user_vector, score_metrics
from myai.models import AssessmentSession, FitFilters, ProductRecord
from myai.persona import generate_persona
...
def test_exports_cover_required_targets():
    ...
    for target, filename in [
        ...
        assert body
    from myai.engine import score_session
    from myai.exports import export_pack_zip
...
def test_major_metrics_have_two_scenario_opportunities():
    ...
    from myai.config import EVENT_TO_METRICS
...
def test_registry_covers_pack_categories_and_workloads():
    from myai.config import MODEL_WORKLOADS
...
def test_local_only_filter_drops_cloud_products():
    ...
    from myai.registry import load_products
...
def test_label_needs_repeat_observations_not_one_strong_answer():
    from myai.profile import workstyle_label
...
def test_adaptive_signal_waits_then_stops():
    from myai.adaptive import diagnostic_signal
    from myai.models import AssessmentSession
