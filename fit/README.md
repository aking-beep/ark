...
This tree lives in the [ARK](https://github.com/aking-beep/ark) monorepo (`fit/` + `apps/consumer`). Upstream history: [github.com/aking-beep/aifit-engine](https://github.com/aking-beep/aifit-engine).
