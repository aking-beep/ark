  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-4 py-10">
      ...
      <section aria-labelledby="use-persona" className="rounded-2xl border p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Type something you actually need help with. AI Fit adds your{" "}
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          Nothing is sent to AI Fit — your message goes to the AI you choose. For Gemini and “Any AI” we copy it so you can
          paste it in.
        </p>
      </section>
