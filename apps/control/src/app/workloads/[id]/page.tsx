...
export default async function WorkloadDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  // The whole point of Control: what AI Fit Teams predicted against what happened.
  ...
  return (
    <div className="space-y-6">
      ...
      {drift != null && (
        ...
        >
          AI Fit Teams estimated <span className="font-mono text-ink-100">{fmt.usd(predictedPerUnit!)}</span> per unit
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Panel title="Observed call shape" subtitle="What gets exported to AI Fit Teams as calibration.">
